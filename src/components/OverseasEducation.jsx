...
const OverseasEducation = () => {
  return (
    <section
      ...
      style={{ background: '#1b2a58', minHeight: '720px' }}
    >
      ...
      <div className="relative max-w-6xl mx-auto px-8 py-0" style={{ minHeight: '720px', display: 'flex', alignItems: 'flex-end' }}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-end w-full">
          ...
          <div className="hidden lg:flex relative justify-center items-end h-[720px] self-end">
            <img
              src="/assets/down.png"
              alt="Students"
              style={{
          ...
          {/* Right: Text + Flags — vertically centered via flex */}
